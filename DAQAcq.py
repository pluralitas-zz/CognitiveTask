    ...
    def acqdaq(self,rate,sam):
        if self.daqfound == True:
            with nidaqmx.Task() as task:
                task.ai_channels.add_ai_voltage_chan("Dev1/ai0:4", terminal_config=nidaqmx.constants.TerminalConfiguration.RSE) #ai0:3 = QC Left, HS Left, QC Right, HS Right, ai4 = PPG Digital Out. Input terminal config=RSE(10083)
