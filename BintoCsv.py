...
col = 13
datatype = 'uint16'
fname = "testt_task_2020-10-03T160054"

savepath = "C:\\Data" #data savepath
fpathin = os.path.join(savepath, fname + ".dat")
fpathout = os.path.join(savepath, fname + ".csv")
head = 'Time*1000,ElapsedTime,Deg*10,Speed,QCLeft*1000,HSLeft*1000,QCRight*1000,HSRight*1000,PPGRaw*1000,HeartRate,InstPower,AvgPower,InstCad,Balance' #header
